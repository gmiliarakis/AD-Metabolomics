...
```{r}
aucs <- c("MLR clinical (benchmark)" = basic$roc$auc, "MLR clinical+ metabolites" = mlr$roc$auc, "MLR clinical+6 factors" = mlrf$roc$auc, "Decision Tree clinical+6 factors" = tree$roc$auc, "XGB Forest clinical+6 factors" = xgb$roc$auc)
knitr::kable(aucs, col.names = "AUC", align = "ll")
```
...
2. Fitting 6 ML-estimated factors obtained by the FMradio package (cummulatively explaining 30% of variace) yields