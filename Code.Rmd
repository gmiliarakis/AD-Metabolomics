...
# Parse p_values to dataframe and transpose it 
...
# Filter out the non-significant FDR-adjusted p-values
...
fit <- function(X = NULL, Y = NULL) {
  ...
  plot(perf.lr,
    ...
    avg = 'threshold',
    lwd = 2,
    main = 'ROC curve from repeated 10-fold CV-Logistic'
  )
  ...
  plot(perf.tree,
    ...
    avg = 'threshold',
    lwd = 2,
    main = 'ROC curve from repeated 10-fold CV-Decision Tree'
  )
  ...
  plot(
    ...
    avg = 'threshold',
    lwd = 2,
    main = 'ROC curves from repeated 10-fold CV-Random Forest'
  )
  #Store metrics in a new dataframe
