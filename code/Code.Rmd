...
DegreesE4yes <- as.data.frame(NetStatsE4yes[, 1], row.names = rownames(NetStatsE4yes))
DegreesE4no <-  as.data.frame(NetStatsE4no[, 1], row.names = rownames(NetStatsE4no))
head(order(DegreesE4yes, decreasing = TRUE))
