...
\begin{threeparttable}
\begin{tabular}{clllll} \toprule
Model  & Fitting & AUC & Accuracy (95/\% CI) & P(NIR $>$ Accuracy) & NIR \\ \midrule
...
This study had two aims: to unveil potentially unknown pathways of systemic metabolic deregulation attributed to ApoE4 (dose or presence), and to propose a multi-faceted methodology for high-dimensional data analysis in the context of AD. To this end, three analytical approaches were taken: differential expression, multiclass classification and network analysis.

The global test for ApoE4 dose effects on serum metabolite levels revealed positive dose effects on lipids in AD, mainly triglycerides and diglycerides. This is consistent with evidence from Caucasian \cite{Maxwell2013APOEMT,CARVALHOWELLS20121447,Bernath2020SerumTI} and southern Chinese populations \cite{Gan2022EffectsPopulation}. While the same test was not significant in the SCD group, only two sphingomyelin species showed trends of a negative, but mostly amines and amino acids in this group. This could putatively reflect compensatory mechanisms still in place for the poor lipidation and clearance potential of ApoE4.
